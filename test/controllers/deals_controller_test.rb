...
class DealsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deal" do
    assert_difference('Deal.count') do
      post deals_url, params: { deal: { adoption_request_id: @deal.adoption_request_id, kitten_request_id: @deal.kitten_request_id, state: @deal.state } }
    end
  ...
  test "should update deal" do
    patch deal_url(@deal), params: { deal: { adoption_request_id: @deal.adoption_request_id, kitten_request_id: @deal.kitten_request_id, state: @deal.state } }
